...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getUsersBackend(variables?: GetUsersBackendQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUsersBackendQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUsersBackendQuery>(GetUsersBackendDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getUsersBackend', 'query');
    }
  };
}
